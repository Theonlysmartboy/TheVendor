...
public class SeedsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    //recyclerview object
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = mDatabase.orderByChild("category").equalTo("Agriculture");
