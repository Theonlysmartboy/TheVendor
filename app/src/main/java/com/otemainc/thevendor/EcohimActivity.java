...
public class EcohimActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    //recyclerview object
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecohim);
        ...
        Query query = mDatabase.orderByChild("category").equalTo("Physical & Biological Sciences");
