...
public class OrdersActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnItemClickListener  {
    //recyclerview object
    private RecyclerView recyclerView;

    //adapter object
    private AgricultureItemsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = mDatabase.orderByChild("category").equalTo("Bought");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    ClientUploads upload = postSnapshot.getValue(ClientUploads.class);
                   uploads.add(upload);
                }
                //creating adapter
                adapter = new AgricultureItemsAdapter(getApplicationContext(), uploads);
    ...
    public void onClick(View view, int position) {
        ...
        // Toast.makeText(DrinksActivity.this, "Authentication failed.",
